...
import com.feedbackapp.DatabaseHandler.*;
...
public class UploadActivity extends ListActivity {
    ...
    private static DatabaseHandler dbupload;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbupload = new DatabaseHandler(getApplicationContext());
...
//                    intent.setType("*/*");
                    ...
                    List<FeedBack> feedback = dbupload.getAllFeedBacks();
